...
public class BNPssGUI extends JFrame implements Utility, PSSbehaviours{
	...
	private JTextField HHBnopLs;
	private JTextField HHBOPpac2L;
	private JTextField HHBnopPac2L;
	...
	BNPssGUI(){
			...
			unitHeader = PssHeaderFact.unitHeader();
			...
			etroHeader = PssHeaderFact.etroHeader();
			...
			pac_3OpHeader = PssHeaderFact.OPheader();
			pac_3OpHeader.setBounds(853, 63, 40, 52);
			getContentPane().add(pac_3OpHeader);
			
			pac_3InopHeader = PssHeaderFact.launcherInopHeader();
			...
			pac_3Header = PssHeaderFact.pac3Header();
			pac_3Header.setBounds(853, 42, 121, 20);
			getContentPane().add(pac_3Header);
		
			gemCHeader = PssHeaderFact.gemCheader();
			...
			HHBnopLs = new JTextField();
			HHBnopLs.setEnabled(false);
			HHBnopLs.setBackground(Color.GRAY);
			HHBnopLs.setToolTipText("");
			HHBnopLs.setColumns(10);
			HHBnopLs.setBounds(1469, 116, 77, 48);
			getContentPane().add(HHBnopLs);
			...
			HHBnopPac2L = new JTextField();
			HHBnopPac2L.setBackground(Color.GRAY);
			HHBnopPac2L.setEnabled(false);
			HHBnopPac2L.setToolTipText("");
			HHBnopPac2L.setColumns(10);
			HHBnopPac2L.setBounds(1469, 164, 77, 48);
			getContentPane().add(HHBnopPac2L);
			...
			fireUnitData fUData = new fireUnitData(starter, lBackGround, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, starter, uData);
...
/* ----Use this code to update the local data variables with the REcieved JSon Objects. I only had time to do one of them So in any test you do set your PSS unit to Alpha. 
if(uData.getUnitDesignator().equals("Alpha")){
	...
	aUnitId.setBackground(fUData.getStatusBackGround());
